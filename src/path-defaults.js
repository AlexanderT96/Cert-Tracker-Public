...
(function(global){
  ...
  const additions=Object.freeze(['cwna','cwisa','cisco-meraki-solutions']);
  ...
  const focusTracks=Object.freeze([
    Object.freeze({id:'cwnp-wifi',title:'CWNP enterprise Wi-Fi depth',status:'OPTIONAL',why:'CWNA and CWISA are visible core milestones; continue with CWAP for deep troubleshooting, CWDP for architecture-stage design, CWSP for security and CWNE only when experience and peer-review requirements are met.',certs:Object.freeze(['cwap','cwdp','cwsp','cwne']),resources:Object.freeze([{label:'CWNP certifications and study material',url:'https://www.cwnp.com/certifications/cwna'}])}),
