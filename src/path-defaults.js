...
(function(global){
  ...
  const groups=[
    ...
    ['Expert networking and wireless capstone',['ccie-enterprise','cwne'],'Expert networking and CWNP design authority; qualify and book only when experience and evidence requirements are met']
  ];
  ...
  const additions=Object.freeze(['cwna','cwisa','cisco-meraki-solutions','cwap','cwdp','cwsp','cwne']);
