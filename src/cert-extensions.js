...
(function extendCertifications() {
  ...
  const additions = [
    ...
    cwnp('cwisa','Certified Wireless IoT Solutions Administrator','CWISA-103',2,'WIRELESS','Core wireless-IoT administration milestone covering short-range radio, LPWAN, location services, supporting networks, APIs and operational integration; it also satisfies the CWISA component of the later CWNE route.',['Wireless IoT foundations','Short-range wireless protocols','LPWAN technologies','Location services','Supporting networks and APIs','IoT operations and project fundamentals'],[],{roi:8,note:'Visible core wireless-IoT milestone and a later CWNE requirement. Treat it as applied multi-technology administration, not merely a prerequisite checkbox.'}),
    ...
    },
    {
      ...
      note:'Developer-focused AI rung. Schedule only after PCAP-level Python progress and AI-901; it must not compete with active networking, wireless or current-role study. Estimated hours, difficulty and ROI are planning estimates.',
      sourceUrl:'https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-apps-and-agents-developer-associate/',deps:['pcap','ai-901']
    },
    {
      id:'briefcam-tech', name:'Milestone BriefCam Technical Certification', code:'BRIEFCAM-TECH', phase:1, track:'ROLE-DRIVEN', gateway:false, tier:'B', vendor:'Milestone Systems / BriefCam', provider:'Milestone Systems / BriefCam',
      validity:18, cost:'Authorised-partner technical class; dated public class listed €800 before tax. Confirm current UK partner price.', costNum:690, cvValue:4500, cvValueConfidence:'LOW', cvValueScope:'UK roles with active BriefCam deployment, support or lawful investigation responsibility', verifiedAt:'2026-09-13', employer:true, free:false, cpe:0, cpePeriod:18, difficulty:6, roi:8, hours:[24,45],
      coverage:'Install, configure and troubleshoot BriefCam video analytics, then connect Review, Respond and Research capabilities to supported VMS and operator workflows.', prerequisites:'The vendor’s dated public technical-certification class required free BriefCam User and Admin training (3.5 hours total) and authorised-partner access. Confirm the current prerequisite and class availability in Milestone Learning before enrolling.',
      studyMaterials:'Milestone Learning / BriefCam User and Admin training, the current technical class, BriefCam documentation and an authorised XProtect or supported-VMS lab.', subjects:['BriefCam User and Admin foundations','Installation and configuration','VMS and metadata integration','Review, Respond and Research workflows','Troubleshooting','Privacy, audit and human validation'], skills:['Video analytics','VMS integration','Physical security','Troubleshooting','Privacy governance'],
      examFormat:'Instructor-led practical technical certification documented by BriefCam for authorised partners. The public class page states 18-month validity; reconfirm the active assessment and renewal policy in the partner portal.', renewalRule:'The dated official class states certification is valid for 18 months; confirm the current recertification route in Milestone Learning before relying on it.', costStatus:'DATED_PUBLIC_CLASS_PRICE', projectRec:'Build an authorised lab design connecting VMS recording, BriefCam services, analytics search, alerting and operator workflow; document data flow, permissions, false-result checks, audit evidence and recovery checkpoints.',
      tutorBottlenecks:['Separating VMS video flow from BriefCam metadata and analytics-service dependencies','Designing Review, Respond and Research workflows without overstating analytic certainty','Diagnosing ingestion, indexing, permissions and service-health failures from evidence','Applying privacy, audit, retention and human-validation controls to investigative workflows'],
      note:'Visible current-role ecosystem milestone because learning access is confirmed. Queue it behind XCIE and the current Axis work rather than treating visibility as an instruction to start immediately. A dated official BriefCam class documents the technical certification, prerequisites and validity, while current scheduling remains partner-controlled. The £ estimate is low-confidence and contextual, not a guaranteed salary uplift.', officialUrl:'https://www.briefcam.com/lp/20251202-tier-1-technical-training-na-remote-certification-class/', sourceUrl:'https://www.briefcam.com/lp/20251202-tier-1-technical-training-na-remote-certification-class/', deps:[]
    },
    {
      ...
      note:'Useful structured AI vocabulary rung, deliberately sequenced after PCEP-level Python progress. It must not compete with active networking, wireless or current-role study; the real value comes from later analytics, AI-system design and security rather than the badge alone.', sourceUrl:'https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-fundamentals/', deps:['pcep']
    },
    {
