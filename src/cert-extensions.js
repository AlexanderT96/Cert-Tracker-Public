...
(function extendCertifications() {
  ...
  const additions = [
    ...
    {
      id:'briefcam-tech', name:'Milestone BriefCam Technical Certification', code:'BRIEFCAM-TECH', phase:1, track:'ROLE-DRIVEN', gateway:false, tier:'B', vendor:'Milestone Systems / BriefCam',
