...
assert.equal(summary.coreScope,34);assert.equal(summary.coreVerified,29);assert.equal(summary.coreRestricted,5);assert.equal(summary.focusScope,0);assert.equal(summary.focusVerified,0);
