...
// 13 CORE · 30 CONDITIONAL · 9 OPTIONAL · 12 ROLE-DRIVEN · 7 POST-PLAN
// ═══════════════════════════════════════════════════════════════════════════
...
const CERTS = [
  ...
  {
    coverage: "Google Cybersecurity Certificate (Coursera) — 8-course entry series: security foundations, network security basics, Linux & SQL, detection/response, Python automation for security. Portfolio-lite labs throughout.",
    prerequisites: "None — designed for zero-experience entrants.",
    studyMaterials: "Coursera subscription (~£38/mo). With prior experience, treat it as a speedrun: skip-test where allowed, focus the Python-for-security and detection modules.",
    tutorFlag: null,
    subjects: ["Security fundamentals","SOC basics","Python"],
    tracks: ["A","C"],
    id: "google-cyber", name: "Google Cybersecurity Certificate", code: "GOOGLE-CYBER",
    phase: 1, track: "FOUNDATION", gateway: false, tier: "C",
    validity: 0, cost: "~£38/mo Coursera (1-2 months realistic)", costNum: 76, cvValue: 500, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 2, roi: 5, hours: [25, 50],
    vendor: "Google",
  ...
  },
  {
    ...
    projectRec: "None needed — renews automatically on Network+ pass.",
    note: "Auto-renews when Network+ is passed. If Network+ isn't passed before A+ expiry: renew via 20 CE credits through CompTIA CertMaster CE or approved training. Security+ also cascades down and renews A+. Log all CE at comptia.org/ce.",
    deps: []
  },
  {
    coverage: "CompTIA Network+ (N10-009). Covers: networking fundamentals (OSI, TCP/IP, IP addressing, subnetting), network implementations (routing, switching, wireless), network operations (monitoring, documentation, BCP/DR), network security (hardening, secure protocols, network attacks, IAM), network troubleshooting (methodology, common cable/connectivity/performance issues). Depth: entry-intermediate applied. Max 90 questions, 90 min, passing 720/900. CE cert — 3-year renewal.",
    prerequisites: "Networking basics and ~9-12 months hands-on networking exposure (prior infrastructure/support experience covered).",
    studyMaterials: "PRIMARY: Professor Messer free YouTube N10-009 series. EXAM-READY: Boson ExSim N10-009. Renews automatically when Security+ is passed.",
    tutorFlag: null,
    ...
    phase: 1, track: "CORE", gateway: false, tier: "C",
    validity: 36, cost: "~£280 ($369 US list)", costNum: 280, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 30, cpePeriod: 36, difficulty: 5, roi: 7, hours: [70, 110],
    ...
    projectRec: "Packet-capture write-ups for portfolio: DHCP handshake + DNS query in Wireshark, annotated.",
    note: "Auto-renews A+ on pass. Later renewed by Security+ CE cascade. N10-009 passes are valid 3 years. Renew via 30 CEUs or higher cert. CEU cost ~£120 over 3yr — but Security+ pass renews it automatically.",
    deps: []
  },
  {
    ...
    prerequisites: "Physical network literacy, basic IP networking (subnetting, VLANs — Network+ holder), hands-on Axis camera configuration experience helpful. hands-on experience provides useful exposure.",
    ...
    validity: 36, cost: "~£120 (employer)", costNum: 0, cvValue: 1500, verifiedAt: "2026-06", employer: true, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 3, roi: 9, hours: [20, 30],
    ...
    projectRec: "a sanitised deployment walkthrough (redacted): one Axis camera deployment, diagram + IP plan + bandwidth calc. Shows physical-to-network literacy on a CV.",
  ...
  },
  {
    ...
    prerequisites: "Basic Windows Server admin (Milestone runs on Windows), IP networking fundamentals, physical exposure to XProtect deployments. hands-on experience is beneficial.",
    ...
    validity: 36, cost: "~£120 (employer)", costNum: 0, cvValue: 2000, verifiedAt: "2026-06", employer: true, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 4, roi: 7, hours: [30, 50],
    skills: ["XProtect VMS", "Windows Server", "Event rules"],
    examFormat: "Milestone Learning online exam. Multiple choice + scenario. Access through the relevant organisation's partner portal.",
    ...
    note: "Employer funded. Study via Milestone Learning Portal (free with partner login). Book via Pearson VUE. Results immediate. 3-year validity. Prereq for MCIE. Real hands-on work is the best preparation.",
    deps: []
  },
  {
    ...
    studyMaterials: "VENDOR-NATIVE: LenelS2 partner training portal (employer-funded once employer partnership active). No Pluralsight. Supplement: LenelS2 OnGuard product documentation, OAAP integration guides. Push for partner-portal access via technical lead early in Phase 1.",
    tutorFlag: null,
    ...
    phase: 1, track: "ROLE-DRIVEN", gateway: false, tier: "C",
    pending: true,
    validity: 12, cost: "Employer £", costNum: 0, cvValue: 1500, verifiedAt: "2026-06", employer: true, free: false,
    ...
    note: "🎯 LenelS2 ARCHITECTURE TRACK — rung 1 of 4. Employer funded. Register via employer's LenelS2 partner account. OnGuard Core course + Associate exam. VAR-affiliated — deactivates if the holder leaves a representative organisation. 1-year validity, maintained by Distance Learning within 120 days of each OnGuard release. Recertification exam every 2 years. Prereq for LCP/LCE/LCDA.",
    deps: []
  },
  {
    ...
    validity: 0, cost: "~£12 (1 month TryHackMe sub)", costNum: 12, cvValue: 500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    validity: 0, cost: "~£95", costNum: 95, cvValue: 800, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    validity: 36, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 1, track: "CORE", gateway: false, tier: "C",
    validity: 0, cost: "~£74 ($99 USD)", costNum: 74, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 1, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£74 ($99 USD)", costNum: 74, cvValue: 1200, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    studyMaterials: "PRIMARY: Microsoft Learn AI-900 path (FREE, official) — note: the official exam code is AI-900 (there is no AI-901). SECONDARY: Pluralsight AI Fundamentals path. EXAM-READY: Microsoft Learn practice assessment (free). EXAM: ~£89.",
    tutorFlag: null,
  ...
  },
  {
    ...
    validity: 60, cost: "~£55", costNum: 55, cvValue: 800, verifiedAt: "2026-06", marketNote: "PCEP-30-02 remains the active exam version; PCEP-30-03 is in development for Q3 2026. Credential validity is five years; confirm current UK voucher pricing before booking.", employer: false, free: false,
    ...
    note: "⚠ DECIDE BY MID-AUG 2026: sit current version before 31 Aug for a LIFETIME cert, or accept the 7-8yr replacement in Phase 2. Guide-rope cert — no UK job filters for it. Value is structure. Sit only if Python self-study is drifting. Study: automatetheboringstuff.com (free).",
    deps: []
  },
  {
    ...
    validity: 36, cost: "~£362", costNum: 362, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Evidence portfolio — map A+, Network+, CIOS, a representative organisation role to the 5 competency areas. This is the artefact.",
    ...
    applicationGuide: {
      ...
      steps: [
        ...
        { title: "5. Identify and approach two referees", detail: "Referees must be 'familiar with the applicant’s technical knowledge and work-based experience' per Cyber Scheme guidance. Best fits: a technical lead, senior colleague who's seen cyber work, an external contact who's worked with the applicant on relevant incidents or projects. Referees must show willingness — they are subject to random verification by UKCSC." },
        ...
        { title: "7. Attend professional discussion", detail: "~1 hour, conducted remotely by TWO CIISec Council-approved assessors (at least one in the relevant specialism area for Practitioner+ — broader for Associate). Assessors base discussion on the evidence but may probe further. Treat as an interview." },
      ...
      evidence: [
        ...
        "Management & supervision: any work where the applicant has directed activities (even informally), mentored junior staff, led a project workstream",
      ...
      referees: {
        ...
        whoToAsk: [
          ...
          "Customer-side contact who has seen relevant work directly (e.g. IT manager at a larger enterprise environment)",
          "Anyone with existing UKCSC registration (their endorsement carries extra weight)"
        ]
      },
      pitfalls: [
        "🔴 HIGHEST RISK for this path: Knowledge & application gap. A+/Network+ + general MSP work demonstrates IT competence, not cyber competence. a representative organisation 'Systems Support Engineer' title doesn't read as a cyber role to assessors. The fix: (1) Pass Sec+ first as the recognised cyber technical anchor. (2) Frame relevant workplace or lab experience explicitly as cyber work — physical security system hardening IS cyber-adjacent if framed as security decisions, not just IT configuration. (3) Wait 3-6 months post-Sec+ to accumulate specific cyber-framed deliverables. Submitting pre-Sec+ risks being referred back for insufficient cyber-specific evidence — better to wait than to fail and re-submit.",
        ...
        "Applying too early — wait until Sec+ passed AND ~3-6 months of cyber-relevant workplace or lab work to draw on"
      ],
      note: "✓ Verified against CIISec/UKCSC documentation (April 2026). ACSP is the near-term application target — but ONLY post-Sec+ + 3–6 months of cyber-relevant workplace or lab experience. Pre-Sec+ application risks Knowledge & Application referral-back. £362.40 fee. Timeline: 3-4 months end-to-end. The specialism choice doesn't lock in here (Associate is broader) — but consider which specialism to choose at Practitioner tier. UK CONTEXT: UKCSC is a Royal Charter body — ACSP is the only fully UK-sovereign cyber registration available. The UK Government is gradually mapping UKCSC titles to the Government Cyber Security Career Framework, NCSC Assured roles, and CNI sector requirements. CIISec membership (the route here) also opens UK-specific opportunities: regional chapter events (London, Manchester, Bristol, Edinburgh), CIISec Skills Framework alignment for UK CV branding, eligibility to apply for CIISec mentoring scheme. Application fee is GBP — no FX risk. Consider claiming CIISec membership + £362.40 ACSP fee as a professional subscription via HMRC (if employer doesn't reimburse). (UK CIISec chapters: London, Manchester, Bristol, Edinburgh). Worth attending one event before applying — it's where applicants may meet a referee or the ChCSP holder the applicant eventually needs at Phase 6."
    }
  },
  ...
  // ─── PHASE 2 · Security + AI + Networking · Sep 2026–Mar 2027 ────────────
  {
    ...
    validity: 36, cost: "~£319 ($425 USD; discounts below)", costNum: 319, cvValue: 4000, verifiedAt: "2026-07", marketNote: "NOT yet held. SY0-701 retires ~mid-2027; SY0-801 previews ~Oct 2026. Sit SY0-701 while materials are mature.", roles: ["SOC Analyst","Junior Security Analyst","IT Security Administrator"], employer: false, free: false,
  ...
  {
    id: "secot-plus", name: "CompTIA SecOT+", code: "SOT-001",
    phase: 3, track: "ROLE-DRIVEN", gateway: false, tier: "A",
    validity: 36, cost: "~£340 ($425 USD)", costNum: 340, cvValue: 5000, verifiedAt: "2026-06", marketNote: "GA launch Dec 2026 - sits naturally in the plan once OT experience has accumulated.", roles: ["OT Security Analyst","IT/OT Security Technician"], employer: false, free: false,
    cpe: 60, cpePeriod: 36, difficulty: 6, roi: 9, hours: [40, 80],
    vendor: "CompTIA", tracks: ["B", "C"], subjects: ["OT/ICS", "Convergence", "Critical infrastructure"],
    skills: ["OT/ICS security", "IT/OT convergence", "SCADA / control systems", "OT risk & incident response", "Critical infrastructure"],
    examFormat: "Multiple choice + performance-based, exam code SOT-001 (V1). Expect ~90 Qs / 90 min with PBQs. Launches Dec 2026 — confirm availability before booking.",
    projectRec: "Map a sanitised IT/OT convergence scenario from relevant workplace or lab experience: segment a Purdue-model architecture (Mermaid), correlate a physical-access event with an OT/SCADA alert, document detection + response. On-spearhead evidence for the convergence-architect target.",
    studyMaterials: "Pre-launch (exam SOT-001, ~Dec 2026) — official CompTIA CertMaster + published objectives expected nearer launch. Bridge now with ISA/IEC 62443 materials, the SANS ICS410 / GICSP body of knowledge, NIST SP 800-82 (Guide to OT Security), and free CISA ICS resources. Confirm the official objectives at comptia.org when released.",
    note: "🎯 ON-SPEARHEAD — CompTIA's first dedicated OT-security cert, built explicitly for IT/OT convergence (the target-role theme). Vendor-neutral counterpart to the ISA/IEC 62443 ladder and a natural pair with GICSP/GRID. Launches Dec 2026 (exam SOT-001); CompTIA recommends ~3 yrs OT-adjacent experience + 2 yrs OT cyber, Security+/Network+ level assumed. Self-fund (career-critical — avoid clawback). Verify launch date + price at comptia.org before booking.",
    deps: ["security-plus"]
  },
  {
    coverage: "Genetec Security Center Omnicast Technical — install and configure Security Center video in a single-server environment; maintenance, troubleshooting, and Genetec support access. First rung of the Genetec technical ladder.",
    prerequisites: "2-day instructor-led course SC-OTC-001 (partner/employer access). Network+ level networking assumed.",
    studyMaterials: "VENDOR-NATIVE: Genetec University courseware + Technical Assistance Portal (partner access). Confirm curriculum at genetec.com/training.",
    tutorFlag: null,
    subjects: ["VMS","Genetec Security Center","Video surveillance"],
    tracks: ["B"],
    id: "genetec-omnicast-tech", name: "Genetec Security Center: Omnicast Technical", code: "SC-OTC-001",
    phase: 6, track: "POST-PLAN", gateway: false, tier: "C",
    validity: 0, cost: "Instructor-led (quote via Genetec)", costNum: 0, cvValue: 1200, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 3, roi: 5, hours: [16, 20],
    vendor: "Genetec",
    skills: ["Omnicast video", "Single-server deployment", "Troubleshooting"],
    examFormat: "Certification exam at the end of the 2-day SC-OTC-001 course.",
    projectRec: "None — course lab is the evidence.",
    note: "Rung 1 of the Genetec ladder. Adds the #2 VMS to a Milestone-focused stack — multi-vendor credibility is the consultancy differentiator. Partner access required — a representative security integrator is not currently a route; treat as negotiation/next-employer item.",
    deps: []
  },
  {
    coverage: "Genetec Security Center Synergis Technical — install and configure Synergis access control within Security Center; hardware enrolment, cardholder management, troubleshooting. Access-control rung of the Genetec ladder.",
    prerequisites: "2-day instructor-led course SC-STC-001 (partner/employer access). Network+ level networking assumed.",
    studyMaterials: "VENDOR-NATIVE: Genetec University courseware + Technical Assistance Portal (partner access). Confirm curriculum at genetec.com/training.",
    tutorFlag: null,
    subjects: ["Access control","Genetec Security Center","Synergis"],
    tracks: ["B"],
    id: "genetec-synergis-tech", name: "Genetec Security Center: Synergis Technical", code: "SC-STC-001",
    phase: 6, track: "POST-PLAN", gateway: false, tier: "C",
    validity: 0, cost: "Instructor-led (quote via Genetec)", costNum: 0, cvValue: 1200, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 3, roi: 5, hours: [16, 20],
    vendor: "Genetec",
    skills: ["Synergis access control", "Hardware enrolment", "Troubleshooting"],
    examFormat: "Certification exam at the end of the 2-day SC-STC-001 course.",
    projectRec: "None — course lab is the evidence.",
    note: "Rung 2 of the Genetec ladder — access-control twin of Omnicast. Pairs with LenelS2/Paxton experience for cross-vendor access design credibility.",
    deps: []
  },
  {
    id: "genetec-sc-ent", name: "Genetec Security Center: Enterprise Technical Certification", code: "SC-ETC-001",
    studyMaterials: "Genetec Technical Assistance Portal (TAP) + Genetec University instructor-led courseware (partner/employer access). Prerequisite: the Omnicast (SC-OTC-001) or Synergis (SC-STC-001) foundational course. Network+ level networking assumed. Confirm current curriculum at genetec.com/training.",
    phase: 6, track: "POST-PLAN", gateway: false, tier: "B",
    validity: 0, cost: "Instructor-led (quote via Genetec)", costNum: 0, cvValue: 3000, verifiedAt: "2026-06", roles: ["VMS / Access Control Designer","Physical Security Engineer"], employer: false, free: false,
    difficulty: 5, roi: 6, hours: [16, 24],
    vendor: "Genetec", tracks: ["B"], subjects: ["VMS", "Access control", "Physical security"],
    skills: ["Genetec Security Center", "Multi-site federation", "High availability / failover", "Unified VMS + access control", "System design"],
    examFormat: "Open-book practical exam at the end of a 2-day instructor-led course (SC-ETC-001, Advanced). Prerequisite: Omnicast SC-OTC-001 (video) or Synergis SC-STC-001 (access control).",
    projectRec: "Build a multi-server Security Center lab: configure a two-site Federation, Archiver encryption, and Directory failover; document a unified video + access design as competitor-platform parity with LenelS2/Milestone lab or project work.",
    note: "Competitor-platform literacy (outside the primary production stack). Genetec Security Center is a top-tier unified VMS + access-control platform; the Enterprise cert (SC-ETC-001) sits atop the Omnicast (video, SC-OTC-001) and Synergis (access, SC-STC-001) foundational courses and is the design/architect tier. Useful breadth for a convergence architect — promote into My Path only if a customer or employer runs Genetec.",
    deps: ["genetec-omnicast-tech","genetec-synergis-tech"]
  },
  {
    ...
    tracks: ["A","B","C"],
    id: "cysa-plus", name: "CompTIA CySA+", code: "CS0-004",
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£319 ($425 USD)", costNum: 319, cvValue: 3500, verifiedAt: "2026-07", roles: ["SOC Analyst (Tier 2)","Threat / Vulnerability Analyst","Incident Responder"], employer: false, free: false,
    ...
    note: "🔄 VERSION: CS0-004 live since 23 Jun 2026 (CS0-003 retired same day — no overlap). Same format (85Q/165min/750 pass), same 3yr CE renewal; new blueprint adds explicit AI coverage (use, governance, risks), more cloud-native, IR weight up 20→24%. Use CS0-004-aligned materials only. Defensive analysis bridge to SC-200/Sentinel. Renewal: 60 CEUs/3yr OR cascade-renew by passing SecurityX (CAS-005). Auto-renews Security+ and Network+ when passed. Study: Jason Dion Udemy + Professor Messer. Build SIEM detection rules for portfolio.",
    deps: ["security-plus"]
  },
  {
    ...
    prerequisites: "CompTIA recommends A+ (already achieved) and Network+ (already achieved) plus 12+ months practical Linux admin experience. Realistic skills before sitting: comfortable in Bash shell, familiar with SSH, sudo, package managers, systemd basics, can read Linux logs, basic Bash scripting confidence. NEW for XK0-006: Python basics + Git workflow + one Ansible playbook ideally written. Lab time critical — most candidates fail without 40+ hours hands-on practice.",
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£277 ($369 USD)", costNum: 277, cvValue: 3000, verifiedAt: "2026-06", roles: ["Linux Systems Engineer","Security Engineer (Linux)"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£370", costNum: 370, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£277 ($369 USD)", costNum: 277, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 4000, verifiedAt: "2026-06", marketNote: "STRATEGY: study Jeremy's IT Lab NOW for job-depth - sit the v2.0 exam mid-2027 (v1.1 retires 10 Feb 2027; ~80% of content carries over). Knowledge now, exam when current.", roles: ["Network Engineer","Network Security Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    validity: 36, cost: "~£275", costNum: 275, cvValue: 2000, verifiedAt: "2026-06", roles: ["SOC Analyst (entry)"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£150", costNum: 150, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£83", costNum: 83, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 1, track: "ROLE-DRIVEN", gateway: false, tier: "C",
    validity: 36, cost: "~£250 (employer)", costNum: 0, cvValue: 3000, verifiedAt: "2026-06", employer: true, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 6, roi: 9, hours: [60, 80],
    skills: ["XProtect Corporate", "Failover", "Clustering"],
    examFormat: "Milestone Learning online exam. Multiple choice + hands-on XProtect configuration tasks. Access through the relevant organisation's partner portal.",
  ...
  {
    coverage: "Milestone Certified Design Engineer — design-track specialist cert (parallel to, not above, MCIE). Covers: enterprise VMS system design, bandwidth/storage calculations, multi-site architecture, redundancy/failover design, integration with third-party access control and analytics, SCADA/ICS integration considerations.",
    prerequisites: "Standalone design track — no formal cert prereq. Benefits strongly from hands-on XProtect deployment experience.",
    ...
    phase: 1, track: "ROLE-DRIVEN", gateway: false, tier: "A",
    validity: 36, cost: "£0 (employer-funded)", costNum: 0, cvValue: 3500, verifiedAt: "2026-06", roles: ["VMS Design Engineer","Physical Security Solutions Designer"], employer: true, free: false,
  ...
  {
    coverage: "Arcules cloud VSaaS — sales-level positioning cert for the Arcules cloud video surveillance platform (Canon Group; merged with Milestone Systems July 2024). Covers cloud VMS vs on-premise comparison, Arcules solution portfolio, and partner quoting/proposal context. Complements the on-premise Milestone stack with cloud/hybrid positioning knowledge.",
    prerequisites: "None. Arcules/Milestone partner portal access required.",
    studyMaterials: "VENDOR-NATIVE: Arcules/Milestone partner portal (employer-funded). No public prep material available.",
    tutorFlag: null,
    subjects: ["Arcules cloud VSaaS", "Cloud vs on-premise VMS", "Arcules platform portfolio", "Partner sales positioning", "Hybrid VMS context"],
    tracks: ["B"],
    seVariant: true, id: "arcules-csp", name: "Arcules Certified Sales Professional", code: "ARCULES-CSP",
    phase: 1, track: "ROLE-DRIVEN", gateway: false, tier: "B",
    validity: 0, cost: "Employer (Milestone/Arcules partner)", costNum: 0, cvValue: 800, verifiedAt: "2026-06", employer: true, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 3, roi: 6, hours: [5, 15],
    skills: ["Cloud VSaaS positioning", "Arcules platform knowledge", "Hybrid VMS sales"],
    examFormat: "Arcules/Milestone partner portal. Format not publicly documented — likely short online assessment.",
    projectRec: "N/A — sales cert, no portfolio project.",
    note: "Sales-level, not technical — note accordingly. Employer-funded partner cert. Arcules merged with Milestone July 2024, so positions cloud/hybrid alongside XProtect. Cert spec not publicly indexed; hours/difficulty estimated.",
    deps: []
  },
  {
    ...
    phase: 1, track: "ROLE-DRIVEN", gateway: false, tier: "B",
    pending: true,
    validity: 12, cost: "Employer £", costNum: 0, cvValue: 2500, verifiedAt: "2026-06", employer: true, free: false,
  ...
  },
  {
    ...
    pending: true,
    validity: 12, cost: "Employer £", costNum: 0, cvValue: 3000, verifiedAt: "2026-06", employer: true, free: false,
    ...
    projectRec: "🎯 LenelS2 ARCHITECTURE TRACK — rung 3 of 4. Moved to Phase 3 to reflect eligibility driven by deployment hours. LCE is technical depth tier; pursue after 2–3 enterprise OnGuard deployments provide enough hands-on depth.",
  ...
  },
  {
    ...
    pending: true,
    validity: 12, cost: "Employer £", costNum: 0, cvValue: 4000, verifiedAt: "2026-06", roles: ["Access Control Systems Designer","Physical Security Architect"], employer: true, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 60, cost: "~£150", costNum: 150, cvValue: 2000, verifiedAt: "2026-06", marketNote: "PCAP-31-03 remains the active exam version; PCAP-31-04 is in development for Q3 2026. Credential validity is five years; confirm current UK voucher pricing before booking.", employer: false, free: false,
    ...
    note: "⚠ DECIDE BY MID-AUG 2026: sit current version before 31 Aug for a LIFETIME cert, or accept the 7-8yr replacement in Phase 2. Guide-rope cert — no UK job filters. Sit only if Python self-study is drifting. Covers OOP, modules, exceptions, std lib.",
    deps: ["pcep"]
  },
  {
    ...
    validity: 0, cost: "~£195", costNum: 195, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Build a real Python tool that has a genuine operational use: a camera-event → ArcGIS bridge, a Sentinel KQL-results emailer, or a multi-camera health-check REST client. The portfolio piece matters more than the badge.",
    note: "The genuinely useful Python cert tier — proves the holder can engineer, not just script. Most relevant for camera-analytics–GIS integration code, AI-security tooling, and detection automation. Self-funded.",
    deps: ["pcap"]
  },
  {
  ...
  },
  {
    ...
    phase: 3, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£280", costNum: 280, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£280", costNum: 280, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    applicationBased: true,
    validity: 36, cost: "~£600", costNum: 600, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Specialism evidence pack — map Security+, CySA+, SAL1, defensive security work to Secure Operations competencies.",
    ...
    applicationGuide: {
          ...
          "steps": [
                ...
                },
                {
                      ...
                      "detail": "Practitioner tier requires CIISec Associate membership as prerequisite. If the applicant is already a CIISec member from ACSP application, this is settled. Otherwise apply for Associate grade first (separate application). UKCSC Practitioner application via CIISec is the second step."
                },
                {
          ...
          "referees": {
                ...
                "outreachTemplate": "LinkedIn / email outreach script: 'Hi [Name], I'm applying for UKCSC Practitioner registration. The application requires someone familiar with my cyber security practitioner-level work in [the specialism] work to act as a [referee/endorser]. Would you be willing? It's typically a structured form or short written confirmation, plus possible follow-up if they need to verify details. Happy to walk through what's involved on a quick call. Application takes [N] months — no urgency. I'd really value support.' Approach 3-4 candidates to secure 2 confirmed yeses.",
                "whoToAsk": [
  ...
  // ─── PHASE 3 · Cloud On-Ramp + DevOps · Apr–Nov 2027 ─────────────────────
  {
    ...
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 4000, verifiedAt: "2026-06", marketNote: "The single long-form priority for late 2026 - pair with short vendor certs to protect momentum during the low-pace period.", roles: ["Azure Administrator","Cloud Operations Engineer"], employer: false, free: false,
    ...
    projectRec: "Hub-and-spoke VNet deployment: 2 spokes, NSGs, Azure Firewall, VPN gateway, diagnostic logging. Clean README, architecture diagram, decision log. This IS a portfolio.",
  ...
  },
  {
    ...
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "AVD deployment in personal Azure tenant: 2-host pool, FSLogix profiles, conditional access, cost report. Doubles as a a representative organisation pitch artefact for client managed-cloud services.",
    note: "STRATEGIC FIT: directly bridges support/infrastructure experience to a representative organisation's stated openness to managed cloud services for clients. AVD/Windows 365 is where 'managed virtual resources for clients' becomes a real product. Pursue alongside or after AZ-104. ⚠ 1-year validity, free renewal via Learn. Half-price via Virtual Training Day.",
    deps: ["az-104"]
  },
  {
    ...
    validity: 0, cost: "~£235", costNum: 235, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    validity: 24, cost: "~£60", costNum: 60, cvValue: 4000, verifiedAt: "2026-06", roles: ["Infrastructure Engineer","Cloud / DevOps Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£55 (exam direct via PSI)", costNum: 55, cvValue: 4000, verifiedAt: "2026-06", roles: ["Secrets / Platform Engineer","DevSecOps Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    prerequisites: "AZ-104 OR AZ-204 is a hard prerequisite for the credential. Realistic skills before study: can write YAML pipelines from scratch (both Azure Pipelines and GitHub Actions), understand Git branching strategies, have deployed at least one end-to-end CI/CD to Azure, comfortable with containers (Docker + basic Kubernetes), can write KQL queries. Terraform literacy strongly recommended (IaC is near-mandatory). The 50-55% weight on build/release pipelines means if the applicant has never written a production pipeline, the applicant are not ready. prior infrastructure/support experience helps: the applicant already understand 'something must be deployed reliably' — but now the applicant must automate it.",
    ...
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 5000, verifiedAt: "2026-06", roles: ["DevOps Engineer (Azure)","Platform Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    applicationBased: true,
    validity: 36, cost: "~£840", costNum: 840, cvValue: 5000, verifiedAt: "2026-06", expReq: "Senior-level experience evidenced through a Licensed Body", marketNote: "DIRECT ENTRY (verified Jun 2026): apply at the level relevant experience matches - Associate/Practitioner rungs are not prerequisites. Saves ~£960 and ~70h.", employer: false, free: false,
    ...
    projectRec: "Principal-level evidence: architecture decisions the applicant has owned across AZ-104/AZ-400/SC-500/CKA + relevant workplace or lab experience. Package as a single evidence PDF.",
    ...
    applicationGuide: {
          ...
          "steps": [
                ...
                {
                      "title": "8. Post-award: positions the applicant for ChCSP",
          ...
          "evidence": [
                ...
                "Continuing development plan: forward-looking, showing how the applicant will contribute to specialism development over the next 3 years"
          ],
          "referees": {
                "guidance": "Referees/endorsers must speak credibly to the expert-level work in [the specialism] and adjacent specialisms work. Best practice: one internal (manager/senior colleague) + one external (peer, customer-side contact, former colleague). Both should have worked with the applicant for ≥1 year and seen the relevant work first-hand.",
                "outreachTemplate": "LinkedIn / email outreach script: 'Hi [Name], I'm applying for UKCSC Principal registration. The application requires someone familiar with my expert-level work in [the specialism] and adjacent specialisms work to act as a [referee/endorser]. Would you be willing? It's typically a structured form or short written confirmation, plus possible follow-up if they need to verify details. Happy to walk through what's involved on a quick call. Application takes [N] months — no urgency. I'd really value support.' Approach 3-4 candidates to secure 2 confirmed yeses.",
                "whoToAsk": [
                      "a technical lead or senior engineer who has seen cyber/architecture work",
                      "Former colleague at MSP-side senior level",
                      "Customer-side contact at a current or former employer (especially someone in IT leadership)",
  ...
  // ─── PHASE 4 · Identity, Security & Containers · Dec 2027–Jul 2028 ───────
  {
    ...
    phase: 3, track: "CORE", gateway: false, tier: "A",
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 4000, verifiedAt: "2026-06", roles: ["Identity & Access Administrator","IAM Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    studyMaterials: "SC-500 replaces AZ-500; it complements rather than replaces the distinct SC-200 security-operations and SC-300 identity tracks. PRIMARY: current Microsoft Learn SC-500 study guide and learning path. LAB: disposable Azure/hybrid environment covering Entra ID, Key Vault, network, storage, compute, Defender and AI-workload controls. Practice Assessment was not available on the official credential page when checked 10 Sep 2026; verify before booking. Regional price remains unverified.",
    ...
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 5000, verifiedAt: "2026-06", roles: ["Microsoft Security Operations Engineer","Security Engineer (Azure)"], employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 7, roi: 10, hours: [80, 120],
  ...
  },
  {
    ...
    validity: 24, cost: "~£350", costNum: 350, cvValue: 4000, verifiedAt: "2026-06", roles: ["Kubernetes Engineer","Platform / DevOps Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    validity: 24, cost: "~£350", costNum: 350, cvValue: 6000, verifiedAt: "2026-06", roles: ["Kubernetes Security Engineer","Cloud-Native Security Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£310 (includes 1 free retake)", costNum: 310, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 4500, verifiedAt: "2026-06", roles: ["Microsoft Security Operations Analyst","SOC Analyst (Defender / Sentinel)"], employer: false, free: false,
  ...
  },
  {
    ...
    validity: 0, cost: "~£400 (includes training + free retake)", costNum: 400, cvValue: 4000, verifiedAt: "2026-06", roles: ["Penetration Tester"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 36, cost: "~£800 (self-study path with exam + first retake)", costNum: 800, cvValue: 4000, verifiedAt: "2026-06", expReq: "ISMS implementation/audit experience strongly recommended", roles: ["ISMS Lead Implementer","GRC / Compliance Analyst"], employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 6, roi: 8, hours: [60, 80],
    ...
    projectRec: "Draft an ISMS scoping document + risk register + Statement of Applicability for a hypothetical CNI-adjacent client (mapped to a representative organisation's actual client profile, sanitised). This is what converts CISSP theory into 'I've led an ISMS implementation' on the CV — and is immediately reusable if a representative organisation ever pursues ISO 27001 certification.",
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£165 (or free with HTB Silver Annual)", costNum: 165, cvValue: 3500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£165", costNum: 165, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    prerequisites: "Network+ (already achieved), Security+ (Phase 1) recommended. CompTIA suggests 3-4 years hands-on infosec + dedicated pentest study. Realistic skills before sitting: comfortable with nmap fluently, used Burp Suite Community on at least 5 web app challenges, completed 20+ HTB/THM machines, can explain OWASP Top 10 by exploit type, basic Bash and Python for tool customisation.",
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£319 ($425 USD)", costNum: 319, cvValue: 4000, verifiedAt: "2026-06", roles: ["Penetration Tester","Vulnerability Analyst"], employer: false, free: false,
  ...
  },
  {
    ...
    studyMaterials: "PRIMARY: TryHackMe Pentest+ + Junior Penetration Tester paths (covered in Phase 2-4). SECONDARY: TCM Security Practical Ethical Hacking + Practical Web App Pentesting (~£25/mo). HANDS-ON: HTB labs subscription (~£15/mo) — 50+ machines minimum before booking. CREST Examination Centre prep: CREST publishes CPSA + CRT syllabus PDFs (FREE on crest-approved.org). EXAM-READY: Boson + book CREST mock practical via approved provider (~£300). Note: CREST does not authorise specific training providers — the applicant build readiness independently.",
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£600", costNum: 600, cvValue: 6000, verifiedAt: "2026-06", roles: ["Penetration Tester (CREST)","Security Consultant"], employer: false, free: false,
  ...
  // ─── PHASE 5 · Architect + Senior Security · Aug 2028–Mar 2029 ───────────
  {
    ...
    tutorFlag: "LOW TUTORING CASE. Self-study path is well-trodden with strong free resources. Only tutoring worth considering: a single 2-hour session with an Azure architect reviewing prepared whiteboard architectures before exam. Codementor senior Azure architect ~£80-120 for the session. Not essential if practice exam scores are strong.",
    ...
    validity: 12, cost: "~£124 ($165 USD)", costNum: 124, cvValue: 5000, verifiedAt: "2026-06", roles: ["Azure Solutions Architect","Cloud Security Architect"], employer: false, free: false,
    ...
    projectRec: "Reference architecture for a hypothetical cloud-managed VMS service: hub-and-spoke for multi-tenant client video, Milestone Husky cloud-shift, Azure Storage tiering for camera footage, Private Link, identity, cost model. Doubles as an internal pitch artefact for a cloud-services business case.",
  ...
  },
  {
    ...
    validity: 36, cost: "~£600", costNum: 600, cvValue: 9000, verifiedAt: "2026-06", roles: ["Senior Penetration Tester","Lead Security Consultant"], employer: false, free: false,
  ...
  },
  {
    ...
    validity: 0, cost: "~£399 (course + exam bundle, lifetime)", costNum: 399, cvValue: 6000, verifiedAt: "2026-06", roles: ["Red Team Operator","Adversary Simulation Specialist"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£99", costNum: 99, cvValue: 4000, verifiedAt: "2026-06", roles: ["Web App Penetration Tester","AppSec Analyst"], employer: false, free: false,
  ...
  },
  {
    ...
    applicationGuide: {
          ...
          "route": "ISC2 direct application. Pass CISSP exam first, THEN apply for endorsement within 9 months. Endorsement requires another active ISC2 member in good standing to vouch for the 5-year experience claim across the 8 CISSP domains. If the applicant cannot find an endorser personally, ISC2 itself can endorse the applicant based on documentation (slower route).",
          ...
          "steps": [
                ...
                },
                {
                      ...
                      "detail": "If the applicant doesn't yet have 5 years of cyber-specific experience (likely the case at Phase 5 ~2030-2031), pass exam → become Associate of ISC2 → 6 years to accumulate experience → submit endorsement when ready. Associate AMF $50/yr (cheaper). For the intended career progression: probably Associate route initially, then convert when relevant workplace or lab experience + future architect work crosses the 5-year threshold."
                },
                {
                ...
                },
                {
                      ...
                      "detail": "Computerized Adaptive Testing (CAT) globally now. Algorithm ends as early as Q100 if confident, max 150. Bring 2 forms of ID. After passing, the applicant receive notification within hours and the 9-month endorsement clock starts."
                },
                {
                ...
                },
                {
                      ...
                      "detail": "Track via ISC2 portal. CPEs from: conferences, training, ISC2 webinars (free), volunteer activities, ISC2 chapter participation, mentoring, publishing. Many activities the applicant will do naturally count. AMF $135/yr. Re-validation cycle ongoing."
                }
          ],
          "evidence": [
                "🔴 HIGHEST RISK: Cyber-specific experience credibility. By Phase 5 (~2030-2031) the applicant will need 5 years of qualifying cyber work post-Sec+. relevant engineering + future architecture roles + Phase 2-4 cyber-specific work should clear this. Document continuously throughout Phases 2-5 — don't try to reconstruct retrospectively.",
          ...
          "pitfalls": [
                ...
                "Applying too early in Associate route — better to wait until the applicant has genuine domain coverage to argue, otherwise risks rejection on substance"
          ],
  ...
  },
  {
    ...
    prerequisites: "CompTIA recommends 10+ years general IT, 5+ years hands-on security, plus prior certs equivalent to Network+, Security+, CySA+, Cloud+, PenTest+ (or knowledge equivalents). For the intended career progression: realistically Phase 5 timing (2029-2030) when the applicant would have ~3-4 years cyber-specific experience post-Sec+ + prior infrastructure/support experience. Realistic skills before sitting: comfortable scripting in PowerShell + Python + Bash, can architect a Zero Trust solution from scratch, deep PKI knowledge, fluent in cloud security across at least 2 providers, threat modelling using STRIDE/PASTA.",
    ...
    validity: 36, cost: "~£400", costNum: 400, cvValue: 6000, verifiedAt: "2026-06", roles: ["Senior Security Engineer","Security Architect"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "B",
    applicationBased: true,
    validity: 36, cost: "~£840", costNum: 840, cvValue: 10000, verifiedAt: "2026-06", expReq: "Principal-level track record; leading-practice evidence", roles: ["Chartered Security Professional","Principal Security Consultant"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 6, track: "POST-PLAN", gateway: false, tier: "B",
    applicationBased: true,
    validity: 36, cost: "~£840", costNum: 840, cvValue: 8000, verifiedAt: "2026-06", expReq: "Extensive senior security leadership - Chartered top tier", roles: ["Chartered Security Professional","Lead Security Consultant"], employer: false, free: false,
    ...
    applicationGuide: {
      ...
      steps: [
        ...
        { title: "2. Become Security Institute Full Member (prerequisite)", detail: "Security Institute membership grades: Affiliate (entry), Member (mid), Fellow (senior). Full Member or Fellow grade required for CSyP application. If the applicant is starting fresh, apply for Member grade first (~£200/yr) — assessed on professional standing. Existing professional body credentials (CISSP, PSP, UKCSC tiers) accelerate the membership grade approval." },
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£75 ($100 USD)", costNum: 75, cvValue: 1200, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Spin up a free-tier EC2 + S3 bucket and map each to its Azure equivalent (VM, Blob). The mapping doc warms the applicant up for the SAA-C03 service-by-service comparison.",
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£112 ($150 USD)", costNum: 112, cvValue: 4000, verifiedAt: "2026-06", roles: ["Cloud Engineer","AWS Solutions Architect (Associate)"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 5000, verifiedAt: "2026-06", roles: ["AWS Solutions Architect","Cloud Architect"], employer: false, free: false,
  ...
  // ─── PHASE 6 · Post-Plan · 2029+ ──────────────────────────────────────────
  {
    ...
    validity: 24, cost: "~£440", costNum: 440, cvValue: 4000, verifiedAt: "2026-06", roles: ["AI Governance Specialist","AI Risk Analyst"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 6, track: "POST-PLAN", gateway: false, tier: "B",
    validity: 24, cost: "~£460 (plus IAPP membership)", costNum: 460, cvValue: 4000, verifiedAt: "2026-06", roles: ["Data Protection Officer","Privacy Analyst"], employer: false, free: false,
    ...
    note: "PRIVACY DEPTH TO PAIR WITH AIGP. Together, CIPP/E + AIGP create the rare 'technical architect + credible privacy/governance' profile that fits technical-DPO or Privacy Engineer roles at £80-100k. CNI clients care deeply about GDPR. Only ~15,000 CIPP/E holders globally. Shares IAPP membership (£100/yr) with AIGP — no additional recurring cost. 2-year validity, 20 CPE. Book when either (a) the applicant is landing interviews where privacy comes up, or (b) a representative organisation starts doing EU client work.",
    deps: ["cissp"]
  },
  {
    ...
    applicationBased: true,
    validity: 36, cost: "~£449 ($599 USD)", costNum: 449, cvValue: 6000, verifiedAt: "2026-06", roles: ["Cloud Security Architect","Cloud Security Engineer"], employer: false, free: false,
          ...
          "steps": [
                {
                      ...
                      "detail": "CCSP only makes sense after CISSP for the intended career progression. CISSP holding waives entire 5-year CCSP experience requirement. Target Phase 6 (post-CISSP, ~2032+). If pursuing without CISSP, the 1-year cloud security domain experience requirement is the binding constraint — must be evidenced specifically in cloud, not general security."
                },
                {
                      "title": "2. Confirm CCSP version timing",
                      "detail": "Effective August 1, 2026, CCSP uses a NEW exam outline with AI security integrated across all 6 domains. Verify exam version at time of booking. Materials pre-Aug 2026 cover the older outline and won't fully prepare the applicant for the current exam."
                },
                {
  ...
  },
  {
    ...
    phase: 6, track: "POST-PLAN", gateway: false, tier: "C",
    validity: 36, cost: "~£400", costNum: 400, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    applicationGuide: {
            ...
            "steps": [
                    ...
                    },
                    {
                            ...
                            "detail": "150 questions, 4 hours, scaled 200-800 (pass: 450). Computer-based at PSI/Pearson VUE UK test centres. After passing, the applicant has 5 years to apply for certification."
                    },
                    {
            ...
            "pitfalls": [
                    "Newer cert means fewer career-anchored case studies \u2014 the application must be tightly self-documented",
  ...
  },
  {
    ...
    phase: 6, track: "POST-PLAN", gateway: false, tier: "A",
    applicationBased: true,
    validity: 36, cost: "~£431 ($575 USD)", costNum: 431, cvValue: 8000, verifiedAt: "2026-06", roles: ["Information Security Manager","Security Governance Lead"], employer: false, free: false,
  ...
  },
  {
    ...
    prerequisites: "Formal: none. Realistic: Linux and Windows command-line fluency, TCP/IP networking at packet level, one scripting language (Python or Bash), 40+ compromised lab machines. Community guideline: if the applicant can root a medium HackTheBox in under 2 hours, the applicant is likely ready.",
    ...
    validity: 0, cost: "~£1,260+", costNum: 1260, cvValue: 6000, verifiedAt: "2026-06", roles: ["Penetration Tester","Red Team Operator"], employer: false, free: false,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 6000, verifiedAt: "2026-06", roles: ["Cloud Security Engineer (AWS)","AWS Security Specialist"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£355", costNum: 355, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 7, hours: [30, 50],
  ...
  },
  {
    ...
    phase: 6, track: "POST-PLAN", gateway: false, tier: "B",
    applicationBased: true,
    validity: 36, cost: "~£449 ($599 USD)", costNum: 449, cvValue: 7000, verifiedAt: "2026-06", expReq: "CISSP first + 2 yrs security architecture experience", roles: ["Lead Security Architect","Security Architect (ISC2)"], employer: false, free: false,
    ...
    projectRec: "Three reference architectures from a portfolio (e.g., zero-trust office network, hybrid Azure/AWS landing zone, OT/IT segmentation). Documented with decision rationale.",
    ...
    applicationGuide: {
          ...
          "timeline": "CISSP-holder route: 3-4 months exam prep + 1-2 months endorsement = 4-6 months end-to-end. Without CISSP route: requires 7 years architecture experience + 6+ months exam prep — slower path, less common. By Phase 6 (~2032+) the applicant should hold CISSP, making the 2-year ISSAP path viable.",
          "steps": [
                {
                      "title": "1. Plan AFTER CISSP for the intended career progression",
                      "detail": "CISSP path is significantly faster (2 years experience) vs 7 years standalone. Target Phase 6 — by then the applicant should hold CISSP and have 2+ years architecture work to evidence. Both pathways are equally valued post-2023 (ISC2 changed the listing convention to 'John Smith, ISSAP, CISSP' — ISSAP listed first as the more advanced credential)."
                },
                {
                      "title": "2. Confirm exam version (Aug 2025 overhaul)",
                      "detail": "ISC2 completely overhauled ISSAP in August 2025 — entire domains restructured. Pre-Aug 2025 study materials WILL NOT prepare the applicant adequately. Download current exam outline from ISC2 directly. New domain structure emphasises Infrastructure Security Architecture (21%) and Security Operations Architecture (18%) as the largest sections."
                },
                {
          ...
          "evidence": [
                ...
                "Domain coverage: target 1+ ISSAP domain explicitly demonstrated. For the intended career progression, likely strongest: Infrastructure Security Architecture (largest at 21%) + Security Operations Architecture",
          ...
          "pitfalls": [
                ...
                "Pursuing 7-year standalone path when CISSP is faster — wait for CISSP unless the applicant has specific reason",
  ...
  },
  {
    ...
    prerequisites: "🔴 EXPERIENCE GATEKEEPER: ASIS requires 5 years progressive physical security experience (3 years if the applicant has a relevant Bachelor's degree). a representative organisation trajectory clearly accumulates this — by Phase 5 (~2030-2031) the applicant will have ~5 years post-A+/Net+ physical security experience plus prior MSP work. Application reviewed by ASIS before exam authorisation. Realistic skills before sitting: comfortable with CPTED principles, CCTV design lifecycle, access control architecture standards, basic risk assessment frameworks (US-leaning but globally applied).",
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 36, cost: "~£385", costNum: 385, cvValue: 4000, verifiedAt: "2026-06", expReq: "4-6 yrs progressive physical security experience", roles: ["Physical Security Consultant","Security Surveyor"], employer: false, free: false,
    ...
    projectRec: "PSP itself is signal — sanitised customer engagements during Phase 3-5 ARE the portfolio (sanitised case studies of security designs the applicant contributed to). Build a PSP-themed GitHub repo with redacted CPTED-aligned site security assessments — rare junior evidence for a typically senior cert.",
  ...
  },
  {
    ...
    prerequisites: "🔴 EXPERIENCE GATEKEEPER: ISC2 requires 4 years cumulative paid full-time work experience in 1+ of the 8 CSSLP domains (or 3 years with relevant Bachelor's). Realistic timing: Phase 5-6 once the applicant has 3-4 years cyber-engineering work post-Sec+ IF Track C is direction. Associate of ISC2 route available with no experience — pass exam, earn experience post-cert. ISC2 endorsement required (existing CSSLP/CISSP holder vouches).",
    ...
    phase: 6, track: "POST-PLAN", gateway: false, tier: "B",
    validity: 36, cost: "~£449 ($599 USD)", costNum: 449, cvValue: 5000, verifiedAt: "2026-06", roles: ["Application Security Engineer","Secure Software Architect"], employer: false, free: false,
    ...
    applicationGuide: {
            ...
            "steps": [
                    ...
                    },
                    {
                            ...
                            "detail": "Endorser must be in good standing and able to vouch for relevant experience. Failing that, ISC2 can endorse directly (slower)."
                    },
                    {
            ...
            "referees": {
                    ...
                    "whoToAsk": [
                            ...
                            "ISC2 chapter member the applicant has networked with"
                    ]
            },
            "pitfalls": [
  ...
  {
    coverage: "Claroty platform deployment — CPS/OT asset discovery, protocol inspection, zone/conduit mapping, and IT/OT SOC integration (ServiceNow, Splunk, Palo Alto). Gartner CPS MQ Leader, positioned highest for execution and vision (2025/2026).",
    prerequisites: "Partner/employer access to Claroty Academy. Networking fundamentals + OT context (62443 CFS level) assumed.",
    studyMaterials: "VENDOR-NATIVE: Claroty Academy courseware (partner access). Confirm current certification track names at Claroty Academy before booking.",
    tutorFlag: null,
    subjects: ["OT security","Asset visibility","CPS platforms"],
    tracks: ["B","C"],
    id: "claroty-cert-eng", name: "Claroty Platform Certified Engineer", code: "CLAROTY-CE",
    phase: 4, track: "IDENTITY-SEC", gateway: false, tier: "B",
    validity: 24, cost: "Partner-gated (pricing on request — negotiate access)", costNum: 0, cvValue: 2000, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 4, roi: 8, hours: [20, 35],
    vendor: "Claroty",
    skills: ["Claroty deployment", "OT asset discovery", "Zone/conduit mapping", "PAN/Splunk integration"],
    examFormat: "Vendor exam following Claroty Academy track (format varies by track — verify).",
    projectRec: "Map a lab camera/access estate as a Claroty asset inventory with zones/conduits — the convergence artifact.",
    note: "MULTIPLIER: the CPS-visibility layer between physical estates and cyber stack. Deepest Palo Alto integration of the MQ leaders — compounds the PAN cluster. Sequence alongside PAN NGFW work in P4. Access is partner-gated — negotiate via employer or fold into next-role offer.",
    deps: []
  },
  {
    coverage: "Nozomi Networks platform deployment — Guardian sensor placement, passive/Smart Polling asset discovery, AI anomaly detection, Vantage cloud aggregation, wireless spectrum (Guardian Air). Gartner CPS MQ Leader; strongest large-scale distributed OT/IoT visibility.",
    prerequisites: "Partner/employer access to Nozomi certification programme. Networking + OT fundamentals assumed.",
    studyMaterials: "VENDOR-NATIVE: Nozomi Networks partner certification courseware. Confirm current track at nozominetworks.com partner portal.",
    tutorFlag: null,
    subjects: ["OT security","Asset visibility","IoT"],
    tracks: ["B","C"],
    id: "nozomi-cert-eng", name: "Nozomi Networks Certified Engineer", code: "NOZOMI-CE",
    phase: 5, track: "ARCHITECT", gateway: false, tier: "B",
    validity: 24, cost: "Partner-gated (pricing on request — negotiate access)", costNum: 0, cvValue: 2000, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 4, roi: 8, hours: [20, 35],
    vendor: "Nozomi Networks",
    skills: ["Nozomi Guardian", "Distributed OT visibility", "Sensor architecture", "AI anomaly detection"],
    examFormat: "Vendor exam following partner certification course (verify current format).",
    projectRec: "Design a multi-site sensor placement plan for a distributed CCTV/access estate — sensor architecture is the differentiator.",
    note: "MULTIPLIER: second CPS platform = vendor-flex per client (mirrors the CrowdStrike+PAN dual-toolkit thesis). Distributed-visibility strength maps directly onto multi-site physical estates. Dragos skipped — GRID covers the threat-intel lane.",
    deps: []
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 48, cost: "~£800–7,800", costNum: 7800, cvValue: 18000, verifiedAt: "2026-06", marketNote: "FUNDING PLAY: target employer/consultancy sponsorship at the next role - SANS is routinely funded; £7.8k self-funded is the plan's largest cash item and the £18k signal does not expire.", roles: ["OT / ICS Security Engineer","Industrial Cyber Security Specialist"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 0, cost: "~£500–1,000", costNum: 800, cvValue: 4000, verifiedAt: "2026-06", marketNote: "IC32 course + this cert unlock the Fast Track route below.", roles: ["OT Security Analyst","ICS Compliance Analyst"], employer: false, free: false,
    ...
    projectRec: "Map existing physical security knowledge (LenelS2 OnGuard, Axis camera networks, etc.) against IEC 62443 zone-conduit principles. The bridging doc demonstrates IT/OT/physical convergence literacy.",
    note: "Lifetime cert (no renewal). Cheaper precursor to GICSP — useful if uncertain about full GICSP commitment. Recognised in UK CNI procurement and an explicit requirement in many OT roles. Pairs naturally with existing physical security domain depth.",
    deps: ["network-plus"]
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 0, cost: "~£800-1,000 (standalone) / ~£3,500+ (ISA training bundle)", costNum: 1000, cvValue: 6000, verifiedAt: "2026-06", marketNote: "Cost-saver: after CFS, the 5-day Fast Track course (IC48) replaces the three individual courses (IC33/IC34/IC37) - then sit exams for Certs 2, 3 and 4 in any order.", employer: false, free: false,
  ...
  },
  {
    ...
    validity: 0, cost: "~£360", costNum: 360, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Pre-exam scenario: document a real architecture decision from the relevant workplace or lab experience (or a sanitised version) covering business driver, options, decision rationale, and outcome. The doc IS the exam evidence.",
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£600", costNum: 600, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£431 ($575 USD)", costNum: 431, cvValue: 4000, verifiedAt: "2026-06", expReq: "3 yrs IT risk and control experience", roles: ["IT Risk Analyst","GRC Specialist"], employer: false, free: false,
    ...
    projectRec: "Build one risk register + treatment plan for a fictional UK SME (e.g., a fictional UK SME profile). Use NIST RMF or ISO 31000 framework. Document control selection rationale, residual risk, and KRIs. The artefact serves both CRISC study and Insurance Risk Engineer niche portfolio.",
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£431 ($575 USD)", costNum: 431, cvValue: 6000, verifiedAt: "2026-06", roles: ["IT Auditor","Security Compliance Analyst"], employer: false, free: false,
    ...
    applicationGuide: {
            ...
            "referees": {
                    ...
                    "whoToAsk": [
                            "audit manager or senior auditor the applicant has worked with",
                            "internal audit committee member",
                            "Big 4 audit partner if the applicant has engaged with them",
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 48, cost: "~£1,030 (standalone) / ~£6,000 (with SANS course)", costNum: 1030, cvValue: 8000, verifiedAt: "2026-06", roles: ["OT Incident Responder","ICS Threat Hunter"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£1,980 (course + exam bundle)", costNum: 1980, cvValue: 7000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "~50 multiple-choice & multiple-select questions, 2 hours. Online-proctored or onsite. Pass/fail (no published scaled score). Valid 3 years; recertify by re-exam.",
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£94 ($125 USD)", costNum: 94, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Deploy the camera-event webhook receiver on Cloud Run — same portfolio artifact, third cloud.",
    note: "Third-cloud exposure kept deliberately thin: ACE proves multi-cloud literacy for architect conversations without committing a full ladder. Speedrun via Google Cloud Skills Boost.",
    deps: []
  },
  {
    ...
    examFormat: "Google Cloud Professional exam - ~50-60 multiple-choice & multiple-select questions, 2 hours, online-proctored or onsite; ~$200 USD ($100 renewal); passing ~70%. Valid 2 years (recertify by re-exam).",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£150 ($200 USD)", costNum: 150, cvValue: 5000, verifiedAt: "2026-06", roles: ["Cloud Security Engineer (GCP)"], employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "MEDDIC Academy online course with assessment (sales methodology); self-paced, certificate of completion, no formal exam centre or expiry. Confirm at meddic.academy.",
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~\u00a3320 ($399 USD)", costNum: 320, cvValue: 1000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 3, roi: 5, hours: [12, 20],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Pragmatic Institute - course attendance plus an online exam (~50 multiple-choice, ~80% pass); certificate does not expire. Confirm at pragmaticinstitute.com.",
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~\u00a31,500 ($1,895 USD)", costNum: 1500, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 4, roi: 7, hours: [16, 24],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "IAPP exam via Pearson VUE - ~90 multiple-choice questions, 2.5 hours, scaled passing ~300/500. Maintained via CPE; recertify every 2 years. Confirm current spec at iapp.org.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~\u00a3440 ($550 USD)", costNum: 440, cvValue: 4000, verifiedAt: "2026-06", roles: ["Privacy Manager","Data Protection Officer"], employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Invigilated closed-book exam via BCS (Pearson VUE or online proctored). Multiple-choice, ~2 hours, foundation level. Certificate does not expire. Confirm current question count at bcs.org.",
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~\u00a3235 (exam-only)", costNum: 235, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 4, roi: 6, hours: [40, 60],
    applicationBased: false, seVariant: false,
    ...
    projectRec: "None needed — course-assessed.",
    note: "UK-specific management-principles cert (BCS) — HR-recognised in gov/CNI tenders where CISSP is premature. Bridges toward ISO 27001 LI.",
    deps: ["security-plus"]
  },
  {
    ...
    examFormat: "Now the Fortinet FCP - Network Security track (legacy 'NSE 4' designation). Two exams via Pearson VUE - FCP_FGT_AD FortiGate Administrator plus one elective; ~30-40 questions each, ~65-90 min. FCP valid 2 years. Confirm current FortiGate version at training.fortinet.com.",
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~\u00a3320 ($400 USD)", costNum: 320, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 6, hours: [40, 60],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "OffSec hands-on proctored practical exam in a live lab (multi-day, ~48 hours) followed by a professional report - no multiple-choice. Certification does not expire. Confirm at offsec.com.",
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 0, cost: "~\u00a31,400 ($1,649 USD)", costNum: 1400, cvValue: 7000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 9, roi: 8, hours: [100, 200],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Google Cloud Professional exam - ~50-60 multiple-choice & multiple-select questions, 2 hours, online-proctored or onsite; ~$200 USD ($100 renewal); passing ~70%. Valid 2 years (recertify by re-exam).",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 24, cost: "~£150 ($200 USD)", costNum: 150, cvValue: 6000, verifiedAt: "2026-06", roles: ["Google Cloud Architect","Cloud Architect"], employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Google Cloud Professional exam - ~50-60 multiple-choice & multiple-select questions, 2 hours, online-proctored or onsite; ~$200 USD ($100 renewal); passing ~70%. Valid 2 years (recertify by re-exam).",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£150 ($200 USD)", costNum: 150, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Fortinet FCSS Security Operations - one exam via Pearson VUE (~30-40 questions, ~65 min), product/version-specific. FCSS valid 2 years. Confirm current version at training.fortinet.com.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~\u00a3320 ($400 USD)", costNum: 320, cvValue: 4000, verifiedAt: "2026-06", roles: ["SOC Analyst (Fortinet)","Security Operations Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Fortinet Certified Expert (FCX) - the program's top tier (successor to NSE 8). Advanced scenario/practical exam via Pearson VUE with FCSS-level prerequisites. Confirm current format at training.fortinet.com.",
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 24, cost: "~\u00a3400 ($500 USD)", costNum: 400, cvValue: 7000, verifiedAt: "2026-06", roles: ["Senior Network Security Engineer","Fortinet Security Architect"], employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "OffSec hands-on proctored practical exam in a live lab (multi-day, ~48 hours) followed by a professional report - no multiple-choice. Certification does not expire. Confirm at offsec.com.",
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 0, cost: "~\u00a31,500 ($1,649 USD)", costNum: 1500, cvValue: 6000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 9, roi: 7, hours: [150, 250],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "OffSec hands-on proctored practical exam in a live lab (multi-day, ~72 hours) followed by a professional report - no multiple-choice. The program's hardest credential; does not expire. Confirm at offsec.com.",
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "S",
    validity: 0, cost: "~\u00a31,500 ($1,649 USD)", costNum: 1500, cvValue: 9000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 10, roi: 7, hours: [200, 400],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "MEDDICC online course + assessment (advanced sales qualification); self-paced, certificate of completion. Confirm at meddicc.com.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 0, cost: "~\u00a31,500 ($1,895 USD)", costNum: 1500, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 4, roi: 5, hours: [25, 40],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Pragmatic Institute Certified Product Manager - course plus online exam (~multiple-choice, ~80% pass); certificate does not expire. Confirm at pragmaticinstitute.com.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 0, cost: "~\u00a32,000 ($2,500 USD)", costNum: 2000, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 6, roi: 7, hours: [40, 60],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "75 questions (multiple-choice & multiple-response), 180 minutes, online-proctored or test centre; scaled 100-1000, passing 750. Valid 3 years.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 36, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 5000, verifiedAt: "2026-06", roles: ["DevOps Engineer","Cloud DevOps Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£269 (UK exam) / ~£600 (PeopleCert bundle with eBook)", costNum: 269, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Map current MSP or integrator workflow to ITIL 4 practices — show how incident/request/change tickets map to specific ITIL 4 practices. Commit as Markdown to GitHub portfolio.",
  ...
  },
  {
    ...
    validity: 36, cost: "~£1,500-2,500 (full 4-module pathway)", costNum: 2000, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~£431 ($575 USD)", costNum: 431, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 6, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 48, cost: "~£1,030 (standalone) / ~£6,000 (with SANS course)", costNum: 1030, cvValue: 8000, verifiedAt: "2026-06", roles: ["Malware Analyst","Reverse Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 48, cost: "~£1,030 (standalone) / ~£6,500 (with SANS course)", costNum: 1030, cvValue: 8000, verifiedAt: "2026-06", roles: ["Digital Forensics Analyst","DFIR Specialist"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£400-2,000 (modular)", costNum: 400, cvValue: 4000, verifiedAt: "2026-06", roles: ["Detection Engineer","Threat Hunter"], employer: false, free: false,
    ...
    note: "🎯 STANDARD MENTAL MODEL FOR DETECTION ENGINEERING. Framework-centric (ATT&CK specifically) — distinct from vendor-centric certs like Splunk SCDA or CrowdStrike CCFA. Increasingly the language used in detection engineering job descriptions and SOC architecture discussions. Strong fit for Track C detection engineer / threat hunter roles. Lower demand at junior tiers; clearer value at Mid → Senior. Modular structure means the applicant can earn 1-2 most-relevant certs (CTI + Threat Hunting most common) rather than full MAD title. Free fundamentals badge worth getting even if rest not pursued — universal language for cyber-defence conversations.",
    deps: ["btl1"]
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 0, cost: "~£550", costNum: 550, cvValue: 5000, verifiedAt: "2026-06", roles: ["Enterprise Architect","Security Architect"], employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 6, hours: [50, 80],
    ...
    projectRec: "TOGAF ADM walkthrough applied to one of existing portfolio projects (Linux+ hardening environment, AI integration, etc.) — produce architecture vision + business architecture + IS architecture documents using TOGAF templates. Strong artefact for senior architect interviews.",
  ...
  {
    coverage: "CSA Certificate of Competence in Zero Trust (CCZT) — vendor-neutral zero-trust architecture: ZT strategy, planning, implementation across identity, device, network, workload and data pillars. Self-study, online exam, no expiry.",
    prerequisites: "None formal. SC-300/SC-100-level identity and architecture context makes it a fast pass.",
    studyMaterials: "CSA official CCZT study bundle + free CSA Zero Trust Training modules. Verify current bundle pricing at cloudsecurityalliance.org.",
    tutorFlag: null,
    subjects: ["Zero trust","Security architecture"],
    tracks: ["A","C"],
    id: "cczt", name: "CSA Certificate of Competence in Zero Trust", code: "CCZT",
    phase: 5, track: "ARCHITECT", gateway: false, tier: "B",
    validity: 0, cost: "~£280 ($350 bundle — verify at CSA)", costNum: 280, cvValue: 1500, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 3, roi: 6, hours: [25, 40],
    vendor: "CSA",
    skills: ["Zero-trust architecture", "ZT planning", "Pillar mapping"],
    examFormat: "Online, open-book style 60Q multiple choice (verify current format at CSA).",
    projectRec: "Map a converged camera/access estate onto ZT pillars — one-pager that slots straight into the SC-100/SABSA architecture portfolio.",
    note: "KEYWORD + FLUENCY ADD: every architecture tender now asks for zero-trust language; SC-100/SABSA touch it, this names it on the CV. No expiry, excellent £/hour. Sequence within the P5 architecture cluster.",
    deps: []
  },
  {
    coverage: "CNet Certified Data Centre Design Professional (CDCDP) — data-centre design across power, cooling, cabling, physical security, monitoring and resilience standards (EN 50600 / TIA-942). The UK-recognised design credential for the DC sector.",
    prerequisites: "Instructor-led programme (typically 5 days). Experience designing physical/electronic security systems maps directly onto the physical-protection modules.",
    studyMaterials: "CNet Training programme materials (included in course). Verify current syllabus and dates at cnet-training.com.",
    tutorFlag: null,
    subjects: ["Data centres","Physical security design","Standards"],
    tracks: ["B"],
    id: "cdcdp", name: "CNet Certified Data Centre Design Professional", code: "CDCDP",
    phase: 6, track: "POST-PLAN", gateway: false, tier: "A",
    validity: 36, cost: "~£3.5k instructor-led — 💰 NEVER SELF-FUND: negotiation/next-employer item", costNum: 0, cvValue: 3000, verifiedAt: "2026-07", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 8, hours: [40, 60],
    vendor: "CNet Training",
    skills: ["DC design", "EN 50600 / TIA-942", "Physical protection", "Resilience"],
    examFormat: "Assessed within the instructor-led programme (verify current format).",
    projectRec: "Design study: converged security architecture for a hyperscale campus — perimeter, CCTV, access, OT segregation — the exact artifact the AI-DC buildout market buys.",
    note: "STRATEGIC MARKET ADD: the AI data-centre buildout is the largest physical-security capex wave in the UK — hyperscale campuses buy exactly the converged profile this plan builds. costNum 0 because this must never be self-funded: it is a job-offer negotiation line. Renewal via CNet CPD — verify terms.",
    deps: []
  },
  {
    ...
    examFormat: "SABSA Foundation = two modules (F1 architecture concepts + F2 risk, governance and design) assessed by multiple-choice exams via APMG / the SABSA Institute. Foundation certificate does not expire. Confirm current format at sabsa.org.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 0, cost: "~\u00a32,000 (incl. course)", costNum: 2000, cvValue: 6000, verifiedAt: "2026-06", roles: ["Security Architect","Enterprise Security Architect"], employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 6, roi: 9, hours: [40, 60],
    applicationBased: false, seVariant: false,
    ...
    projectRec: "Write a SABSA-style attribute profile for a converged physical+cyber estate — direct portfolio piece for the architect story.",
    note: "Architecture *method* credential — the framework language enterprise security architects speak. Pairs with SC-100/CISSP to convert technical depth into architecture narrative.",
    deps: []
  },
  {
    ...
    examFormat: "Esri Technical Certification - multiple-choice, online-proctored (~90 min), aligned to a specific ArcGIS/Enterprise release; tied to product version rather than a fixed expiry. Confirm current spec at esri.com/training.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~\u00a3200 ($250 USD)", costNum: 200, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 7, roi: 7, hours: [60, 90],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification - multiple-choice, online-proctored (~90 min), aligned to a specific ArcGIS/Enterprise release; tied to product version rather than a fixed expiry. Confirm current spec at esri.com/training.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 36, cost: "~\u00a3240 ($300 USD)", costNum: 240, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 7, roi: 7, hours: [100, 140],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification - multiple-choice, online-proctored (~90 min), aligned to a specific ArcGIS/Enterprise release; tied to product version rather than a fixed expiry. Confirm current spec at esri.com/training.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 36, cost: "~\u00a3240 ($300 USD)", costNum: 240, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 7, roi: 8, hours: [100, 140],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification (developer foundation) - multiple-choice, online-proctored, aligned to a specific ArcGIS release. Confirm current spec at esri.com/training.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~\u00a3200 ($250 USD)", costNum: 200, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 6, roi: 8, hours: [50, 70],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification (ArcGIS API for Python) - multiple-choice, online-proctored, aligned to a specific ArcGIS release. Confirm current spec at esri.com/training.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~\u00a3200 ($250 USD)", costNum: 200, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 8, hours: [40, 60],
    applicationBased: false, seVariant: false,
  ...
  {
    coverage: "ArcGIS Online Administration Associate (EAOA). Validates administering ArcGIS Online \u2014 the SaaS/cloud-hosted ArcGIS platform. Relevant where customers use cloud-hosted GIS rather than on-premises ArcGIS Enterprise. Completes the deployment-model coverage (Enterprise on-prem + Online cloud) so the applicant can architect convergence solutions regardless of the customer's hosting choice.",
    ...
    examFormat: "Esri Technical Certification (ArcGIS Online administration) - multiple-choice, online-proctored, aligned to a specific ArcGIS Online release. Confirm current spec at esri.com/training.",
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~\u00a3200 ($250 USD)", costNum: 200, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 6, hours: [40, 60],
    applicationBased: false, seVariant: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification - multiple-choice, online-proctored (~90 min), aligned to a specific ArcGIS Pro release. Tied to product version rather than a fixed expiry. Confirm current spec at esri.com/training.",
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 36, cost: "~\u00a3120 ($150 USD)", costNum: 120, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification - multiple-choice, online-proctored (~90 min), aligned to a specific ArcGIS Pro release. Tied to product version. Confirm current spec at esri.com/training.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~\u00a3180 ($225 USD)", costNum: 180, cvValue: 2000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Esri Technical Certification - multiple-choice, online-proctored (~90 min), aligned to a specific ArcGIS/Enterprise release; tied to product version rather than a fixed expiry. Confirm current spec at esri.com/training.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 36, cost: "~\u00a3180 ($225 USD)", costNum: 180, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 48, cost: "~£1,030 standalone / ~£8,000 with SANS SEC504", costNum: 1030, cvValue: 7000, verifiedAt: "2026-06", roles: ["Incident Responder","SOC Analyst (senior)"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£100", costNum: 100, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£600", costNum: 600, cvValue: 2500, verifiedAt: "2026-06", roles: ["SOC Analyst (EDR)","Endpoint Security Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    validity: 24, cost: "~£200 ($250 USD direct via Pearson VUE)", costNum: 200, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Proctored multiple-choice exam via CrowdStrike University (Next-Gen SIEM / Falcon LogScale); scenario-based. Valid 2 years. Confirm current spec on the CrowdStrike University portal.",
    phase: 5, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£200 ($250 USD)", costNum: 200, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Proctored multiple-choice exam via CrowdStrike University (Next-Gen SIEM engineering / LogScale); scenario-based. Valid 2 years. Confirm current spec on the CrowdStrike University portal.",
    phase: 5, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£200 ($250 USD)", costNum: 200, cvValue: 3500, verifiedAt: "2026-06", roles: ["SIEM Engineer (CrowdStrike)","Security Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Proctored multiple-choice exam via CrowdStrike University; scenario-based on Falcon Identity Protection. Valid 2 years. Confirm current spec on the CrowdStrike University portal.",
    phase: 5, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£200 ($250 USD)", costNum: 200, cvValue: 2500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 15, cpePeriod: 24, difficulty: 5, roi: 6, hours: [30, 60],
    applicationBased: false, seVariant: true,
    skills: ["Identity threat detection", "AD/Entra protection", "Identity policy", "Privileged identity", "CrowdStrike identity stack"],
    projectRec: "Lab: simulate identity attack paths and document Falcon Identity detections — screenshots + write-up.",
    note: "Identity-threat module of the Falcon stack — ITDR is the fastest-growing Falcon lane and pairs with SC-300 identity depth.",
    deps: ["crowdstrike-ccf"]
  },
  {
    ...
    examFormat: "Proctored multiple-choice exam via CrowdStrike University; scenario-based on Falcon Cloud Security. Valid 2 years. Confirm current spec on the CrowdStrike University portal.",
    phase: 5, track: "OPTIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£200 ($250 USD)", costNum: 200, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Lab: protect a demo containerised workload; document CWP policy design.",
    note: "Cloud workload module of the Falcon stack — completes the CrowdStrike toolkit alongside AZ-104/SC-200 cloud grounding.",
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Foundational / Cybersecurity Apprentice). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "D",
    validity: 36, cost: "Free", costNum: 0, cvValue: 1000, verifiedAt: "2026-06", employer: false, free: true,
    ...
    projectRec: "None — coursework only.",
    note: "Free PAN Beacon entry rung — zero-cost onboarding into the PAN dialect. Speedrun target.",
    deps: []
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Foundational / Cybersecurity Practitioner). In-person at Pearson VUE only as of 2026 (no online proctoring). Scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "C",
    validity: 24, cost: "~£112 ($150 USD)", costNum: 112, cvValue: 1500, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "None — coursework only.",
    note: "Second free Beacon rung — cements PAN fundamentals before paid tiers. Keep momentum from Apprentice.",
    deps: []
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Professional). In-person at Pearson VUE only as of 2026. Scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£150 ($200 USD)", costNum: 150, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Homelab: PA-VM (trial) baseline config — zones, security policy, decryption policy; document as build guide.",
    note: "First paid PAN rung — NGFW operational depth. This is where the PAN toolkit becomes CV-credible.",
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Network Security Analyst, Specialist). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Specialist; successor to the retired PCNSE). In-person at Pearson VUE only as of 2026. Scenario-based; passing 860/1000; ~24% Integration & Automation. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 4000, verifiedAt: "2026-06", roles: ["Firewall Engineer","Network Security Engineer"], employer: false, free: false,
    ...
    projectRec: "Design doc: NGFW segmentation for a camera/access estate — zones map to 62443 conduits; publishable artifact.",
    note: "Core PAN engineering credential — the toolkit centrepiece; sequence with Claroty for the OT-segmentation one-two.",
    deps: ["pan-netsec-pro"]
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (SSE / SD-WAN Engineer, Specialist). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 3500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 20, cpePeriod: 36, difficulty: 6, roi: 7, hours: [30, 50],
    applicationBased: false, seVariant: true,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Architect tier, top of the Network Security track). In-person at Pearson VUE only as of 2026. Design/scenario-based; passing 860/1000. Valid 2 years.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 24, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 5000, verifiedAt: "2026-06", employer: false, free: false,
    ...
    projectRec: "Reference architecture: multi-site converged estate on PAN fabric — the portfolio centrepiece.",
    note: "PAN architecture capstone — design-level validation matching the Phase 5 architect band.",
    deps: ["pan-ngfw-eng"]
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Security Operations Professional, Professional). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£150 ($200 USD)", costNum: 150, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 15, cpePeriod: 36, difficulty: 5, roi: 7, hours: [25, 40],
    applicationBased: false, seVariant: true,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Cortex XDR Analyst, Specialist). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 20, cpePeriod: 36, difficulty: 6, roi: 7, hours: [30, 50],
    applicationBased: false, seVariant: true,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Cortex XDR Engineer, Specialist). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 3500, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Cortex XSIAM Engineer, Specialist). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Cortex XSOAR Engineer, Specialist). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£187 ($250 USD)", costNum: 187, cvValue: 3500, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 20, cpePeriod: 36, difficulty: 7, roi: 7, hours: [40, 60],
    applicationBased: false, seVariant: true,
  ...
  },
  {
    ...
    examFormat: "Palo Alto role-based credential (Security Operations Architect, Architect tier). In-person at Pearson VUE only as of 2026 (no online proctoring); scenario-based multiple-choice; passing 860 on a 300-1000 scale. Valid 2 years.",
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "A",
    validity: 24, cost: "~£225 ($300 USD)", costNum: 225, cvValue: 5000, verifiedAt: "2026-06", roles: ["Security Operations Architect","SOC Architect"], employer: false, free: false,
    cpe: 30, cpePeriod: 36, difficulty: 8, roi: 8, hours: [50, 80],
    applicationBased: false, seVariant: true,
  ...
  },
  {
    ...
    examFormat: "Palo Alto Cloud Security Professional - currently the sole certification in the Cloud Security track (Cortex Cloud, runtime, posture). In-person at Pearson VUE only as of 2026; passing 860/1000. Valid 2 years.",
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 24, cost: "~£150 ($200 USD)", costNum: 150, cvValue: 4000, verifiedAt: "2026-06", employer: false, free: false,
    cpe: 20, cpePeriod: 36, difficulty: 6, roi: 7, hours: [30, 50],
    applicationBased: false, seVariant: true,
    ...
    projectRec: "Lab: policy-as-code guardrails on a demo cloud estate; short write-up.",
    note: "Prisma/cloud lane of the PAN stack — pairs with CCSK/Wiz for the cloud-security story.",
    deps: ["pan-practitioner"]
  },
  {
    ...
    validity: 24, cost: "Free", costNum: 0, cvValue: 4000, verifiedAt: "2026-06", roles: ["Cloud Security Engineer","CNAPP Engineer"], employer: false, free: true,
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£100", costNum: 100, cvValue: 4000, verifiedAt: "2026-06", roles: ["SOC Analyst (Splunk)","SIEM Analyst"], employer: false, free: false,
    cpe: 0, cpePeriod: 0, difficulty: 5, roi: 8, hours: [40, 60],
    ...
    projectRec: "Document a custom correlation search the applicant built end-to-end: data source identified → field extraction → search logic → notable event → risk score → response playbook hook. Single page = SOC analyst portfolio piece.",
  ...
  },
  {
    ...
    phase: 5, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 36, cost: "~£100", costNum: 100, cvValue: 6000, verifiedAt: "2026-06", roles: ["SIEM Engineer","Detection Engineer"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 4, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 48, cost: "~£800–7,800", costNum: 7800, cvValue: 6000, verifiedAt: "2026-06", roles: ["Detection Engineer","SOC Analyst (Tier 3)"], employer: false, free: false,
  ...
  },
  {
    ...
    phase: 2, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 0, cost: "~£399", costNum: 399, cvValue: 3000, verifiedAt: "2026-06", employer: false, free: false,
  ...
  },
  {
    ...
    phase: 3, track: "CONDITIONAL", gateway: false, tier: "B",
    validity: 0, cost: "~£599", costNum: 599, cvValue: 5000, verifiedAt: "2026-06", roles: ["Blue Team Analyst (senior)","SOC Analyst (Tier 2–3)"], employer: false, free: false,
  ...
  },
  {
    ...
    validity: 36,
    cost: "~£105 ($130 USD)",
    costNum: 105, cvValue: 1500, verifiedAt: "2026-06",
    employer: false,
    free: false,
    cpe: 0,
    cpePeriod: 0,
  ...
  },
  {
    ...
    costNum: 1700, cvValue: 6000, verifiedAt: "2026-06", marketNote: "Covered by the IC48 Fast Track route - cluster this exam with its sibling soon after the one course.",
    employer: false,
    free: false,
    cpe: 0,
    cpePeriod: 0,
  ...
  },
  {
    ...
    costNum: 0, cvValue: 9000, verifiedAt: "2026-06",
    employer: false,
    free: true,
    cpe: 0,
    cpePeriod: 0,
  ...
  },
  {
    ...
    costNum: 780, cvValue: 3000, verifiedAt: "2026-06",
    employer: false,
    free: false,
    cpe: 36,
    cpePeriod: 36,
  ...
  },
  {
    ...
    costNum: 1030, cvValue: 5000, verifiedAt: "2026-06",
    employer: false,
    free: false,
    cpe: 36,
    cpePeriod: 48,
...
const PHASES = {
  ...
  6: { name: "Chartered & Governance Capstone", window: "Dec 2035–2036", layer: "UK Chartered (ChCSP, CSyP) + CISM + AI governance (AIGP, AAISM)", band: "£90–130k+", roles: ["Lead / Principal Security Architect", "OT-Convergence Solutions Architect", "Chartered Security Consultant", "Head of Security (technical)"] },
};
...
const PHASE_GATES = {
  1: [
    ...
    { id: "p1-env-doc", text: "a representative organisation environment documented: system diagram, integrations, data flows" },
...
if (typeof window !== 'undefined') {
  ...
  window.MARKET_EVENTS = MARKET_EVENTS;
}
